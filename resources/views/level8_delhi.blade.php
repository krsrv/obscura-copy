<html>
  ...
  <?php include_once('nav_after_login.php'); ?>
    ...
    <div class="container-fluid body">
      <div class="parallax-container levels-container valign-wrapper">
            ...
            <div class="row center">
              ...
              <div class="level-content col s12">
                <div class="level-image-container">
                  <img class="level-image" src="/levely/delhi.jpg" usemap="#Map" />
                </div>
              </div> 
        ...
        <div class="parallax">
          ...
          <map name="Map" id="Map">
            <area alt="" title="" href="#" shape="poly" coords="194,249,196,262,204,269,218,272,231,269,242,265,247,257,245,247,233,237,218,239,208,241,199,245" />
    ...
    $('#Map').on('click', function(e) {
      e.preventDefault();
      document.location.pathname = "/level8_sup1_";
    });
    </script>
    <?php
